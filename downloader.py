...
class InstagramDownloaderApp:
    ...
    def submit(self):
        ...
        self.crawl_instagram(profile_link, content_type)

    def crawl_instagram(self, profile_link, content_type):
        try:
            ...
            if content_type == "Videos":
                ...
                self.download_instagram_content(L, reels, "Reels")
        except Exception as e:
            messagebox.showerror("Error", f"Failed to crawl Instagram profile: {e}")

    def download_instagram_content(self, loader, content_posts, content_type):
        target_dir = f"downloads/Instagram/{content_type}"
